...
<CardGroup cols={2}>
  ...
  <Card title="cost" icon="dollar-sign" href="/commands/cost">
  ...
  <Card title="terraform" icon="code-branch" href="/commands/terraform">
    Manage Terraform workspace operations
  </Card>
  
  <Card title="postgres" icon="database" href="/commands/postgres">
